...
public class SSLDv {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Proddvbut.click();
		WebElement dvmulti= driver.findElement(By.xpath("//input[@id='multidomain']"));
		dvmulti.click();
		/*WebElement dvval= driver.findElement(By.xpath("//label[@for='twoyear']"));
		dvval.click();*/
		...
		dvname.sendKeys("Karthik Pillenkiev24");
		...
		WebDriverWait Waitemail=new WebDriverWait(driver,5);
